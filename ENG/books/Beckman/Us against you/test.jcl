...
func baz() {
    defer <question-record><question></question><answer><text>recoverPanic</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record>()
